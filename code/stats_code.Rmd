...
w_anova4 <- aov(`weight_specific growth rate`~temperature, data = SGR4)
summary(w_anova4)
Tukey4 = TukeyHSD(w_anova4, ordered = TRUE)
Tukey4
...
summary(w_anova13) #diet & temp sig
  ...
  #week 13
w_anova13 <- aov(`weight_specific growth rate`~temperature, data = SGR13)
...
w_anova18 <- aov(`weight_specific growth rate`~temperature, data = SGR18)
...
s_anova13<- aov(`size_specific growth rate`~temperature,data=SGR13)
...
s_anova18<- aov(`size_specific growth rate`~temperature,data=SGR18)
