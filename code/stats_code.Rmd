...
kruskal.test(survival_rate ~ Diet, data = week8_survival) 
#significant: 
...
#week 8
oneway.test(`weight_specific growth rate`~treatment, data = SGR8, var.equal = FALSE) #sig
require(rstatix)
